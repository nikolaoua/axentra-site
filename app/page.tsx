        ...
        <div className="mx-auto max-w-6xl px-4 pt-14 pb-12 md:pt-20 md:pb-16">
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            ...
            >
              ...
              <h1 className="max-w-4xl text-4xl font-bold leading-tight tracking-tight text-zinc-900 md:text-5xl lg:text-6xl">
              ...
              <p className="text-zinc-600 text-lg leading-relaxed max-w-xl">
                  Βοηθάμε επιχειρήσεις να μετατρέψουν χρονοβόρες διαδικασίες σε έξυπνα αυτοματοποιημένα συστήματα.
                  Με εργαλεία τεχνητής νοημοσύνης δημιουργούμε λύσεις που εξοικονομούν χρόνο, 
                  μειώνουν λάθη και απελευθερώνουν τους ανθρώπους να επικεντρωθούν σε πιο σημαντική δουλειά.
              </p>
